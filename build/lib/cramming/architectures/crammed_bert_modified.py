    ...
    def forward(self, input_ids, attention_mask: Optional[torch.Tensor] = None, labels: Optional[torch.Tensor] = None, **kwargs):
        ...
        if self.sparse_prediction and labels is not None:            
            ...
            if self.count < 100:
                ...
                print('\nLoss: {}, last_100_losses: {}, layers: {}'.format(masked_lm_loss.item(), last_100_loss, self.cfg.num_transformer_layers))
            else:
                ...
                print('\nLoss: {}, last_100_losses: {}, best_100_losses: {}, layers: {}'.format(masked_lm_loss.item(), last_100_loss, self.best_loss, self.cfg.num_transformer_layers))
