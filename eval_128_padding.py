...
def main_downstream_process(cfg, setup):
    experiment_float64 =True
    if experiment_float64:
    ...
    for task_name, task in tasks.items():
        ...
        # print(colored(f'task["trainloader"]: {task["trainloader"]}'.format(task), 'red'))
        # print(colored(f'task["validloader"]: {task["validloader"]}'.format(task), 'red'))
        # print(colored(f'len(task["trainloader"]): {len(task["trainloader"])}', 'red'))
